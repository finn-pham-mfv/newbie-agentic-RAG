...
### Required ArgumentsThe StepEfficiencyMetric is a trace-only metric and **MUST** be used with `evals_iterator` or `@observe` decorator. It requires:- Setting up tracing with `@observe` decorators
